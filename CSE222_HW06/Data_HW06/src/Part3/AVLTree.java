...
import Part2.BinarySearchTreeWithRotate;
import Part2.BinaryTree;
  ...
  extends BinarySearchTreeWithRotate< E > {
    ...
    /**
     * AVLConstructor for check BinarySearchTree is balanced or not.
     * @param BSTree is BinarySearchTree for check
     */
  public AVLTree (BinarySearchTree BSTree){
    System.out.println("AVLTree: "+ isBalanced(BSTree.root));
  }

    /**
     * Check Tree balanced or not
     * @param node is root node of tree
     * @return boolean if tree is balanced return true, otherwise return false
     */
  boolean isBalanced(Node node)
  {
    ...
    if (total <= 1 && isBalanced(node.left) && isBalanced(node.right))
      return true;
  ...
  private Node<E> rotateLeft(AVLNode<E> leftChild) {


      Node<E> temp = leftChild.right;
